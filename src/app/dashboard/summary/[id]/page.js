...
export default async function PageSummary({ params }) {
  ...
  return (
    <div>
      <header className="h-15 flex flex-row items-center justify-between bg-slate-50 p-2">
        <div>
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
      ...
      <main>
        <div className="container mt-3 flex flex-col items-center justify-center text-left">
          <section className="max-w-[430px] bg-white">
            <h1 className="text-left text-3xl font-bold">{summary.title}</h1>
